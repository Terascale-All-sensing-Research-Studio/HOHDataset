...
"""
This file contains an example of how to retrieve a segmented point cloud.
"""


if __name__ == "__main__":

    # example capture_dir and handover_idx, and target
    ...
    segmented_ptcld_path = du.construct_segmented_pointcloud_path(capture_dir, handover_idx, G_frame_index, target)

    # load the pointcloud
    segmented_ptcl = du.loader(segmented_ptcld_path)

    print(f"Scene pointcloud for frame {G_frame_index} has {len(segmented_ptcl.vertices)} vertices")